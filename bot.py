...
TOKEN = "8538189701:AAHz9NlRKpEaeVmiR1Xta9A77nRQAHagmb0"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await hacker_print(
        update.message,
        "Ciao, amore mio❤️\n\n"
        "✨ Поздравляю тебя с Днём всех влюбленных 🫶\n"
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    responses = {
        ...
        2: "<b>Мне нравится, как ты смеёшься – я влюбляюсь в тебя всё сильней и сильней 🧡</b>",
        3: "<b>Я люблю в тебе всё – даже то, что ты не можешь не замечать 🧐</b>",
        4: "<b>Для меня ты всегда особенная 🥹</b>",
        5: "<b>Я благодарна судьбе за тебя 🖤</b>",
